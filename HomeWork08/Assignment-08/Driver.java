...
public class Driver {
    ...
    public static Map<String, Snack> createSnacks() {
        ...
        snacks.put("Pepsi", new Snack("Pepsi", 1.79, 8));
        snacks.put("Coke", new Snack("Coke", 1.89, 9));
        snacks.put("Cheetos", new Snack("Cheetos", 2.95, 7));
        snacks.put("Doritos", new Snack("Doritos", 3.00, 6));
        snacks.put("KitKat", new Snack("KitKat", 1.79, 4));
        snacks.put("Snickers", new Snack("Snickers", 1.89, 5));
